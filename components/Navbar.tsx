  ...
  return (
    <div className="fixed w-full z-50">
      ...
      <nav className="bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <Link to="/" className="flex items-center gap-2 cursor-pointer">
              <img
                src="/images/Logo-Amor-e-Patas-Pet-Shop-e-Estetica-Animal-pet-shop-pet-shop-perto-de-mim-banho-e-tosa-Uberlandia_.webp"
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 py-6 px-4 space-y-4 shadow-xl animate-in slide-in-from-top-5">
            {menuItems.map((item) => (
              <NavLink
                key={item.label}
                to={item.href}
